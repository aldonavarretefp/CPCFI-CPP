...
void solve(){
    int lengthArr;
    // Check if it is possible to make the array such that the sum of two consecutive elements is the sum of the entire array
    // Posible? YES and print the possible array
    // Otherwise NO
    cin>>lengthArr;
    if(lengthArr % 2 == 0){
        cout<<"YES"<<endl;
